...
COMPRESS      = gzip -9f
DISTNAME      = pvs1.0.0
DISTDIR = /home/jjmg/Documentos/teste/pvModbusClientSample/.tmp/pvs1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtdatabase.h pvapp.h mask1_slots.h $(DISTDIR)/
	$(COPY_FILE) --parents qtdatabase.cpp main.cpp mask1.cpp $(DISTDIR)/
